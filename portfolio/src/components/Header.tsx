...
export const Header = () => {
  ...
  return (
   <header className="sticky top-2 z-20 mt-3 rounded-xl border border-white/40 bg-white/55 backdrop-blur-md px-3 py-3 shadow-sm">
              <div className="flex items-center justify-between gap-2">
                <button
                  type="button"
                  className="md:hidden inline-flex items-center justify-center rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm font-medium text-gray-800"
                ...
                <div className="hidden md:flex items-center gap-6 hover:cursor-pointer">
                  ...
                  <a href="#projects" className="hover:text-red-700">Project</a>
                  <a href="#skills" className="hover:text-red-700">Skills</a>
                ...
                <a href="https://www.linkedin.com/in/inderpreet-singh-a2a5a2249/">
                   <div id="linkedin" className="hover:cursor-pointer transform-transition duration-300 hover:scale-110 ">
                      <button className="h-9 w-9 sm:h-10 sm:w-10 hover:cursor-pointer flex items-center justify-center rounded-lg bg-white shadow-md shadow-gray-200 group transition-all duration-300">
                        <svg className="rounded-md transition-all duration-300 group-hover:scale-110" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 72 72" fill="none">
                ...
                <div className="hover:cursor-pointer transform-transition duration-300 hover:scale-110">
                  <a href="https://www.geeksforgeeks.org/profile/inderpreetsingh2017?tab=activity">
                    <img src={geeks} alt="GeeksforGeeks" className="h-9 w-9 sm:h-10 sm:w-10"/>
                  </a>
                </div>
                   
                <div className="hover:cursor-pointer transform-transition duration-300 hover:scale-110">
                  <a href="https://leetcode.com/u/inderpreet2017/">
                    <img src={leetcode} alt="Leetcode" className="h-9 w-9 sm:h-10 sm:w-10"/>
                  </a>
                </div>
              </div>
            </div>
            ...
            {isMenuOpen && (
              <div className="md:hidden mt-3 border-t border-gray-200 pt-3">
                <div className="flex flex-col gap-2 text-sm">
                  <a href="#about" onClick={() => setIsMenuOpen(false)} className="rounded-md px-2 py-1 hover:bg-gray-100">About</a>
                  <a href="#projects" onClick={() => setIsMenuOpen(false)} className="rounded-md px-2 py-1 hover:bg-gray-100">Project</a>
                  <a href="#skills" onClick={() => setIsMenuOpen(false)} className="rounded-md px-2 py-1 hover:bg-gray-100">Skills</a>
                  <a href="#contact" onClick={() => setIsMenuOpen(false)} className="rounded-md px-2 py-1 hover:bg-gray-100">Contact</a>
                </div>
              </div>
            )}
          </header>
