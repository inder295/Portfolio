...
const iconClass = "h-10 w-10 sm:h-11 sm:w-11 hover:cursor-pointer";

export function Skills() {
  return (
    <section className="mt-16 sm:mt-24" id="skills">
      <motion.h1
      ...
      >
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="rounded-xl border border-gray-200 bg-white/70 p-4">
            ...
            <div className="flex flex-wrap gap-4 mt-4">
              <img src={nodejs} alt="Node.js" className={iconClass} />
              <img src={expressjs} alt="Express.js" className={iconClass} />
              <img src={mongodb} alt="MongoDB" className={iconClass} />
              <img src={postgress} alt="PostgreSQL" className={iconClass} />
              <img src={prisma} alt="Prisma" className={iconClass} />
              <img src={jwt} alt="JWT" className={iconClass} />
            </div>
          </div>
          ...
          <div className="rounded-xl border border-gray-200 bg-white/70 p-4">
            ...
            <div className="flex flex-wrap gap-4 mt-4">
              <img src={aws} alt="AWS" className={iconClass} />
              <img src={docker} alt="Docker" className={iconClass} />
              <img src={cicd} alt="CI/CD" className={iconClass} />
            </div>
          </div>

          <div className="rounded-xl border border-gray-200 bg-white/70 p-4">
            <h2 className="text-lg font-bold">Testing</h2>
            <div className="flex flex-wrap gap-4 mt-4">
              <img src={playwright} alt="Playwright" className={iconClass} />
            </div>
          </div>

          <div className="rounded-xl border border-gray-200 bg-white/70 p-4 sm:col-span-2 lg:col-span-2">
            <h2 className="text-lg font-bold">Languages</h2>
            <div className="flex flex-wrap gap-4 mt-4">
              <img src={javascript} alt="JavaScript" className={iconClass} />
              <img src={typescript} alt="TypeScript" className={iconClass} />
              <img src={c} alt="C++" className={iconClass} />
              <img src={python} alt="Python" className={iconClass} />
            </div>
          </div>
        </div>
      </motion.div>
